...
cot_app.prototype.render = function(fCallback) {
	...
	if (this.includeLogin) {$("#appCode").append('<script type="text/javascript" src="../corev1.0/js/cot_login.js"></script>');}
	...
	$("#appDisplay").load("../corev1.0/html/cot_template_page.html #cot-template-page", function(responseText, textStatus, req) {
		app.searchContext = (app.searchContext||"") ? app.searchContext: "311";
		if (app.searchContext=="INTRA") {$("#cot_intrasearch").removeClass("hide")} else {$("#cot_311search").removeClass("hide")}
