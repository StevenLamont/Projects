...
"0"!==g.ChristmasTree&&(c+="<img src='"+h.ctree+"' alt='Christmas Tree' title='Christmas Tree'>",f+="<span class='iconlbl'>Tree</span>");c+="</p>";c+=f}});""===c?(c="<p class='listingerr'>No collection schedule was found ("+e+")</p>",$("#colCal").hide()):($("#colCal").show(),c="<p class='listinghdr'>The next curbside collection for "+$("#searchLocation").val()+" is on:</p>"+c,$("#calPDFLink").attr("href","//www1.toronto.ca/City%20Of%20Toronto/Solid%20Waste%20Management%20Services/1%20G&R%202.0/2%20Houses/Collection%20Calendar/Calendars/"+
e.replace(/\s/g,"_").toLowerCase()+".pdf"),$("#pdficon").attr("alt",e.replace(/\s/g,"_").toLowerCase()+".pdf"),$("#calPDFId").text(e.replace(/\s/g,"_")+".pdf"),$("#calICSLink").attr("href","//www1.toronto.ca/City%20Of%20Toronto/Solid%20Waste%20Management%20Services/1%20G&R%202.0/2%20Houses/Collection%20Calendar/Calendars/"+e.replace(/\s/g,"_").toLowerCase()+".ics"),$("#icsicon").attr("alt",e.replace(/\s/g,"_")+".ics"),$("#calICSId").text(e.replace(/\s/g,"_")+".ics"));$("#calendar").show();$("#calendarData").html(c)}
function y(a){m=a.MasterCalendar.elements;t()}function z(a,b,d){$("#map").show();l=new google.maps.Map(document.getElementById("map-canvas"),{zoom:18,mapTypeId:google.maps.MapTypeId.ROADMAP,mapTypeControl:!0,mapTypeControlOptions:{style:google.maps.MapTypeControlStyle.DEFAULT,position:google.maps.ControlPosition.TOP_RIGHT},zoomControl:!0,draggable:!1});a=new google.maps.LatLng(a,b);var c=new google.maps.Marker({position:a,map:l,icon:"//maps.google.com/mapfiles/kml/pal2/icon13.png",title:d});l.addListener("center_changed",
