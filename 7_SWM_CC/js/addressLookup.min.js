...
function(){return this.addressObject};b.prototype.promptUser=function(c){for(var a={message:"<b>No extact address was found. Please select one of the following</b>",show:!0,backdrop:!0,closeButton:!0,animate:!0,buttons:{}},d=0;d<c.length;d++){var b=c[d];a.buttons[b.key_Desc]={className:"btn-default addrSelect","data-item":b}}var e=this,f=bootbox.dialog(a);f.on("shown.bs.modal",function(){f.attr("id","addressLookupDiag");f.css("z-index","99001");var a=f.find("button.addrSelect");a.css("width","100%");
a.css("margin","0 0 5px 0");a.on("click",$.proxy(function(a){a=$(a.currentTarget).attr("data-bb-handler");for(var b=0;b<c.length;b++)c[b].key_Desc==a&&(this.addressObject=c[b],$(this.resultsDisplaySelector).html(a),$(this.resultsDisplaySelector).change())},e))})};b.prototype.determineAddresses=function(c){var a=!1,b=[];$.each(c.result.bestResult,function(c,e){"Exact"===e.matchType&&"Address"===e.featureClass&&(b.push(e),a=!0)});a||(b=$.merge(c.result.bestResult,$.merge(c.result.likelyResults,c.result.restOfResults)));
return b};b.prototype.getAddressData=function(){this.results=[];$(this.resultsDisplaySelector).html("");var b=this.apiADDRURLPrefix+encodeURIComponent(this.address)+this.lookupParms(),b=$.ajax({type:"GET",url:b,context:this,dataType:"jsonp",error:function(a,b,c){this.processError.call(this,a,b,c)}});$.when(b).done(function(a){a=this.determineAddresses(a);0===a.length?(a=bootbox.alert("No addresss information found. Please try again with Street Number and Street Name, or a Place Name. "),a.attr("id",
"addressLookupDiag"),a.css("z-index","99001")):1==a.length?(this.addressObject=a[0],$(this.resultsDisplaySelector).html(a[0].key_Desc),$(this.resultsDisplaySelector).change()):this.promptUser(a)})};b.prototype.processError=function(b,a,d){$(this.resultsDisplaySelector).html(a+" "+d)};g.AddressLookup=b})(this);
