...
function updateProgressBar(){var a=$(".step").length-1,b=parseInt($(".step.active").attr("data-step"),10),c=Math.round(b/a*100);$("#stepprogress").css("width",c+"%");$("#stepprogress").attr("aria-valuenow",c);console.log(Math.max(document.documentElement.clientWidth,window.innerWidth||0));480>Math.max(document.documentElement.clientWidth,window.innerWidth||0)?2<b?$("#stepprogress").html("Step "+b+" of "+a):1<b?$("#stepprogress").html(b+" of "+a):$("#stepprogress").html(b):$("#stepprogress").html("Step "+
b+" of "+a);$("#wizard :input:enabled:visible:first").focus()}function processRule(a){var b="";$.each(a,function(a,d){""!==d.op&&(b+="or"===d.op.toLowerCase()?"||":"&&");b+=questions[d.subrule]});a=!1;try{a=eval(b)}catch(c){a=!1}return a}
...
var c=$("#hsi_tabs")[0].getBoundingClientRect(),d=$("#gotoTop").width();$("#gotoTop").css("left",c.left+c.width-d)}
