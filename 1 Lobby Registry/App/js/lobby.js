...
-- frinish add in titles for column headers.. partially done.
...
var rptColumns = { 
    ...
    'BenRpt'  : {Idx: 'A', DataSource : "BeneficiaryArray",
                Cols :  [
                        {column: 'SMLBeneficiary', class: '', style: 'width: 20%', label: 'Beneficiary', title: 'Beneficiary'},
                        {column: 'SMLBusOrg', class: '', style: 'width: 20%', label: 'Business/Org', title: 'Business&#47;Organization'},
                        {column: 'SMLLobbyistNames', class: '', style: 'width: 20%', label: 'Lobbyist Name(s)',  title: 'Lobbyist Name(s)'},
                        {column: 'SMLLobbyistType', class: '', style: 'width: 10%', label: 'Lobbyist Type',  title: 'Lobbyist Type'},                                     
                        {column: 'SMLPrivateFunding', class: '', style: 'width: 20%', label: 'Financial Contributors',  title: 'Financial Contributors'},
                        {column: 'SMLSubjectMatterNo', class: '', style: 'width: 10%', label: 'Subject Matter No.',  title: 'Subject Matter Registration No.'},                                     
                        ]
                },
    'SMRpt'   : {Idx: 'N', DataSource : "jsonData",
                Cols :  [
                        {column: 'SMLLobbyistNames', class: '', style: 'width: 25%', label: 'Lobbyist Name(s)', title: 'Lobbyist Name(s)'},
                        {column: 'SMLBusOrg', class: '', style: 'width: 25%', label: 'Business/Org', title: 'Business&#47;Organization'},
                        {column: 'SMLSubjectMatter', class: '', style: 'width: 32%', label: 'Subject Matter', title: 'Subject Matter'},
                        {column: 'SMLStatus', class: '', style: 'width: 8%', label: 'Status', title: 'Subject Matter Registration  Status'},
                        {column: 'SMLSubjectMatterNo', class: '', style: 'width: 10%', label: 'Subject Matter No.', title: 'Subject Matter Registration No.'},                                     
                        ]
                },
    'LobbyRpt': {Idx: 'A', DataSource : "LobbyistListArray",
                Cols : [
                        {column: 'SMLLobbyist', class: '', style: 'width: 15%', label: 'Lobbyist Name', title: 'Lobbyist Name'},
                        {column: 'SMLLobbyistType', class: '', style: 'width: 9%', label: 'Lobbyist Type', title: 'Lobbyist Type'},
                        {column: 'SMLBusOrg', class: '', style: 'width: 18%', label: 'Business/Org', title: 'Business&#47;Organization'},
                        {column: 'SMLClient', class: '', style: 'width: 18%', label: 'Client', title: 'Client'},
                        {column: 'SMLSubjectMatter', class: '', style: 'width: 20%', label: 'Subject Matter', title: 'Subject Matter'},
                        /*{column: 'SMLStatus', class: 'col-md-1', label: 'Status'},*/
                        {column: 'SMLLobRegNo', class: '', style: 'width: 10%', label: 'Lobbyist<br />Reg No.', title: 'Lobbyist Registration No.'},
                        {column: 'SMLSubjectMatterNo', class: '', style: 'width: 10%', label: 'Subject Matter No.', title: 'Subject Matter Registration No.'},                                     
                        ]
                },
    'BusOrgClientRpt' : {Idx: 'A', DataSource : "BusOrgArray",
                Cols :  [
                        {column: 'SMLBusOrgClient', class: '', style: 'width: 20%', label: 'Business/Org/Client', title: 'Business&#47;Organization&#47;Client'},
                        {column: 'SMLLobbyistNames', class: '', style: 'width: 20%', label: 'Lobbyist Name(s)', title: 'Lobbyist Name(s)'},
                        {column: 'SMLLobbyistType', class: '', style: 'width: 10%', label: 'Lobbyist Type', title: 'Lobbyist Type'},                                                                             
                        {column: 'SMLBeneficiary', class: '', style: 'width: 20%', label: 'Beneficiary', title: 'Beneficiary'},
                        {column: 'SMLPrivateFunding', class: '', style: 'width: 20%', label: 'Financial Contributors', title: 'Financial Contributors'},
	...
	*/
    'FinRpt'  : {Idx: 'A', DataSource : "PrivateFundingArray",
                Cols :  [
                        {column: 'SMLFunding', class: '', style: 'width: 20%', label: 'Financial Contributor', title: 'Financial Contributor'},
                        {column: 'SMLBusOrg', class: '', style: 'width: 20%', label: 'Business/Org', title: 'Business&#47;Organization'},
                        {column: 'SMLLobbyistNames', class: '', style: 'width: 20%', label: 'Lobbyist Name(s)', title: 'Lobbyist Name(s)'},
                        {column: 'SMLLobbyistType', class: '', style: 'width: 10%', label: 'Lobbyist Type', title: 'Lobbyist Type'},                                                                                                                     
                        {column: 'SMLBeneficiary', class: '', style: 'width: 12%', label: 'Beneficiary', title: 'Beneficiary'},
                        {column: 'SMLStatus', class: '', style: 'width: 8%', label: 'Status', title: 'Subject Matter Registration Status'},                                      
                        {column: 'SMLSubjectMatterNo', class: '', style: 'width: 10%', label: 'Subject Matter No.', title: 'Subject Matter Registration No.'},                                     
                        ]
                },
    ...
    'POHCommRpt' : {Idx: 'N', DataSource : "POHArray",
                Cols :  [
                        {column: 'SMLPOHName', class: 'col-md-1', style: '', label: 'POH Name', title: 'Public Office Holder Name'},
                        {column: 'SMLPOHPosType', class: 'col-md-1', style: '', label: 'POH Pos/Type', title: 'Public Office Holder Position&#47;Type'},
                        {column: 'SMLSubjectMatter', class: 'col-md-2', style: '', label: 'Subject Matter', title: 'Subject Matter'},
                        {column: 'SMLLobbyist', class: 'col-md-2', style: '', label: 'Lobbyist', title: 'Lobbyist'},
                        {column: 'SMLCommDate', class: 'col-md-1', style: '', label: 'Comm Date', title: 'Communication Date'},
                        {column: 'SMLMethod', class: 'col-md-1', style: '', label: 'Method', title: 'Method'},
                        {column: 'SMLMeetingReq', class: 'col-md-1', style: '', label: 'Request a Meeting', title: 'Request a Meeting'},                                      
                        {column: 'SMLMeetingReqRes', class: 'col-md-1', style: '', label: 'Result of <br>Meeting Request', title: 'Result of <br>Meeting Request'},                                       
                        {column: 'SMLComReqDate', class: 'col-md-1', style: '', label: 'Date of Request', title: 'Date of Request'},                                     
                        {column: 'SMLSubjectMatterNo', class: 'col-md-1', style: '', label: 'Subject Matter No.', title: 'Subject Matter Registration No.'},                                     
                        ]
                },

    'POHNameRpt' : {Idx: 'A', DataSource : "POHNameArray",
                Cols :  [
                        {column: 'SMLPOHName', class: '', style: 'width: 15%', label: 'POH Name', title: 'Public Office Holder Name'},
                        {column: 'SMLPOHPosType', class: '', style: 'width: 23%', label: 'POH Pos/Type', title: 'Public Office Holder Position&#47;Type'},
                        {column: 'SMLSubjectMatter', class: '', style: 'width: 22%', label: 'Subject Matter', title: 'Subject Matter'},
                        {column: 'SMLLobbyistNames', class: '', style: 'width: 22%', label: 'Lobbyist Name(s)', title: 'Lobbyist Name(s)'},
                        {column: 'SMLStatus', class: '', style: 'width: 8%', label: 'Status', title: 'Subject Matter Registration Status'},
                        {column: 'SMLSubjectMatterNo', class: '', style: 'width: 10%', label: 'Subject Matter No.', title: 'Subject Matter Registration No.'},                                     
                        ]
                },
...
function initApp() {
    ...
    if (document.location.host!="www1.toronto.ca") {
		...
		//strURL = "https://was-intra-qa.toronto.ca/LobbyistAdminWeb/disclosure.do?status=active";
        if (document.location.hostname.length === 0) {
