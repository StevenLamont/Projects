...
" : "+this.checked+"<br>",e+="&"+a+"=true",b=!0)});$(".columnSelect").each(function(a){if(null!==this.id&&(a=$("#"+this.id+" option:selected"),a.length!=this.options.length)){d+=E(this.id).replace("Filter","")+" : ";for(var c="",f=0;f<a.length;f++)d+=a[f].text+", ",c+=a[f].value+",",e+="&"+a[f].value+"=true";d=d.slice(0,-2);c=c.slice(0,-1);y[this.id]=c;d+="<br>";b=!0}});$(".datepicker").each(function(a){null!==this.id&&0<this.value.length&&(y[this.id]=this.value,d+=E(this.id)+" : "+this.value+"<br>",
e+="&"+this.id+"="+this.value,b=!0)});var c=$("#searchString");0<c.val().length?(a=!0,y.searchString=c.val(),e+="&keyword="+c.val(),$("#advSearchBtnGroup").hide()):$("#advSearchBtnGroup").show();var f=$("#advSearchString"),d=d.replace(/Poh /g,"POH ");f.val(d.replace(/<br>/g," ; ").slice(0,-3));$("#lrServiceBar").tooltip("hide").attr("data-original-title",d).tooltip("fixTitle").tooltip("show");b||a?$("#advSearchResetGroup").show():$("#advSearchResetGroup").hide();b?(c.hide(),$("#searchBtn").hide(),
f.show()):(c.show(),$("#searchBtn").show(),f.hide());return e}function W(b){""===b&&(b+="<tr id='nowRows'><td colspan='25'>No Rows Selected</td></tr>");$("#lobbytable").find("tbody").html(b).trigger("update");$("#listLoader").modal("hide");"undefined"!==typeof Storage&&localStorage.setItem("LobbyistDisclosure",JSON.stringify({pageNo:p,currentAlpha:u,nextRow:w,rowsPerPage:x,selectedReport:q,filters:y}))}function X(b){var a="",d=0,e=S();0<r.totalSize&&null!==r.searchResultVOs&&$.each(r.searchResultVOs,
function(b,g){d++;var V=a,k,l=v[q].Cols;k=""+('<tr id="lrRow'+d+'">');for(var h=0;h<l.length;h++)switch(l[h].column){case "SMLLobbyist":k+='<td class="'+l[h].cls+'" style="'+l[h].style+'">'+n(f(g.lobbyistName),e)+"</td>";break;case "SMLLobbyistNames":for(var m='<td class="'+l[h].cls+'" style="'+l[h].style+'">',p=f(g.lobbyistList),u=g.lobbyistType,p=p.split(","),r="",t=0;t<p.length;t++)r=0===t&&-1<u.toLowerCase().indexOf("in-house")?"<b>"+p[0]+"</b>":0===t?r+p[0]:r+(", "+p[t]);k+=m+n(r,e)+"</td>";
break;case "SMLPOHName":k+='<td class="'+l[h].cls+'" style="'+l[h].style+'">'+n(f(g.pohName),e)+"</td>";break;case "SMLPOHNameTitle":k+='<td class="'+l[h].cls+'" style="'+l[h].style+'">'+n(f(g.pohNameOrTitle),e)+"</td>";break;case "SMLPOHPosition":k+='<td class="'+l[h].cls+'" style="'+l[h].style+'">'+n(f(g.posPosition),e)+"</td>";break;case "SMLPOHType":k+='<td class="'+l[h].cls+'" style="'+l[h].style+'">'+n(f(g.pohType),e)+"</td>";break;case "SMLFinContributor":k+='<td class="'+l[h].cls+'" style="'+
l[h].style+'">'+n(f(g.financialContributor),e)+"</td>";break;case "SMLFinContributors":k+='<td class="'+l[h].cls+'" style="'+l[h].style+'">'+n(f(g.financialContributors.join(", ")),e)+"</td>";break;case "SMLLobbyistType":k+='<td class="'+l[h].cls+'" style="'+l[h].style+'">'+f(g.lobbyistType)+"</td>";break;case "SMLBeneficiary":k+='<td class="'+l[h].cls+'" style="'+l[h].style+'">'+n(f(g.beneficiaryName),e)+"</td>";break;case "SMLBeneficiaries":k+='<td class="'+l[h].cls+'" style="'+l[h].style+'">'+
n(f(g.beneficiaries.join(", ")),e)+"</td>";break;case "SMLBusOrg":k+='<td class="'+l[h].cls+'" style="'+l[h].style+'">'+n(f(g.businessOrganization),e)+"</td>";break;case "SMLClient":k+='<td class="'+l[h].cls+'" style="'+l[h].style+'">'+n(f(g.client),e)+"</td>";break;case "SMLSubjectMatter":k+='<td class="'+l[h].cls+'" style="'+l[h].style+'">'+n(f(g.subjectMatter).replace(";","; "),e)+"</td>";break;case "SMLStatus":k+='<td class="'+l[h].cls+'" style="'+l[h].style+'">'+n(f(g.status),e)+"</td>";break;
case "SMLInitFileDate":k+='<td class="'+l[h].cls+'" style="'+l[h].style+'">'+n(f(g.InitialApprovalDate),e)+"</td>";break;case "SMLCommMethod":k+='<td class="'+l[h].cls+'" style="'+l[h].style+'">'+n(f(g.communicationMethod),e)+"</td>";break;case "SMLCommDate":k+='<td class="'+l[h].cls+'" style="'+l[h].style+'">'+n(f(g.communicationDate),e)+"</td>";break;case "SMLRequestMeeting":k+='<td class="'+l[h].cls+'" style="'+l[h].style+'">'+n(f(g.requestMeeting),e)+"</td>";break;case "SMLResultOfMeetingRequest":k+=
'<td class="'+l[h].cls+'" style="'+l[h].style+'">'+n(f(g.resultOfMeetingRequest),e)+"</td>";break;case "SMLDateOfRequest":k+='<td class="'+l[h].cls+'" style="'+l[h].style+'">'+n(f(g.dateOfRequest),e)+"</td>";break;case "SMLSubjectMatterNo":k+='<td class="'+l[h].cls+'" style="'+l[h].style+'"><button class="showSM" title="click to see details"  data-smno="'+f(g.subjectMatterNumber)+'" data-smid="'+g.subjectMatterId+'">'+n(g.subjectMatterNumber,e)+"</button></td>";break;case "SMLLobRegNo":k+='<td class="'+
l[h].cls+'" style="'+l[h].style+'"><button class="showLR" title="click to see details" data-lrno="'+f(g.lobbyistRegistrationNumber)+'" data-lrid="'+g.lobbyistRegistrationId+'">'+n(g.lobbyistRegistrationNumber,e)+"</button></td>"}a=V+(k+"</tr>")});R();W(a);Y(r.totalPages,r.totalSize,b)}function Z(b,a){$.ajax({type:"GET",url:b,crossDomain:!0,dataType:"jsonp",timeout:6E4,success:function(b){r=b;X(a)},error:function(a,b,c){console.log(a.status);console.log(c);$("#lobbytable").find("tbody").html("<tr id='nowRows'><td colspan='25'>No Rows Selected</td></tr>").trigger("update");
$("#PageStatus").hide();$("#listLoader").modal("hide")},complete:function(a,b,c){$("#listLoader").modal("hide");200!==a.status&&bootbox.alert("An error has occured. Please try again.")}})}function aa(){$("#statusFilter").multiselect({onChange:function(b,a,d){D(b,a,d,1)}});$("#pohTypeFilter").multiselect({onChange:function(b,a,d){D(b,a,d,1)},numberDisplayed:1});$("#lobbyistTypeFilter").multiselect({onChange:function(b,a,d){D(b,a,d,1)}})}function ba(){$("#searchBtn").click(function(){0===$("#searchString").val().length?
$("#advSearchBtnGroup").show():$("#advSearchBtnGroup").hide();t()});$("#pageSize").multiselect({onChange:function(a,b,e){x=Number($("#pageSize").val());$("#numberPageSelection").bootpag({page:1});p=w=1;t()}});$("#searchString").keypress(function(a){a=a.which||a.keyCode||0;13!==a&&9!==a||t()});$(".input-daterange").datepicker({todayBtn:!0,forceParse:!1,autoclose:!0,format:"yyyy-mm-dd",date:new Date,todayHighlight:!0,endDate:"0d"});$(".hasclear").keyup(function(){var a=$(this);a.next("span").toggle(!!a.val())});
$(".hastaclear").keyup(function(){var a=$(this);a.parent().next("span").toggle(!!a.val())});$(".clearer").hide($(this).prev("input").val());$(".clearerta").hide($(this).prev("input").val());$(".clearer").click(function(){$(this).prev("input").val("").focus();$(this).hide()});$("#searchStringClear").click(function(){$(this).prev("input").val("").focus();$(this).hide();$("#advSearchBtnGroup").show();t()});$(".clearerta").click(function(){$(".typeahead").typeahead("val","");$(this).hide()});$("#gotoTop").click(function(){window.scrollTo(0,
$("#paging").offset().top)});$("#numberPageSelection").bootpag({total:x,page:1,maxVisible:5,leaps:!0,firstLastUse:!0,first:"\u2190",last:"\u2192",wrapClass:"pagination",activeClass:"active",disabledClass:"disabled",nextClass:"next",prevClass:"prev",lastClass:"last",firstClass:"first"}).on("page",function(a,b){p=b;w=(p-1)*x+1;t();$("#PageNo").html(p)});$(".alphaIdx").click(function(a){F($(this).data("value"));t();return!1});$(".lrCats").on("click",function(){q=this.id;w=1;$("#numberPageSelection").bootpag({page:1});
$("#PageNo").html("1");p=1;G();t()});$("#advSearchApplyBtn").on("click",function(){$("#modalSearch").modal("hide");if(""!==A()){var a=$("#searchString");a.val("");a.hide();$("#searchBtn").hide();$("#advSearchString").show()}G();t()});$("#resetAdvSearchBtn").on("click",function(){J()});$("#resetBtn").on("click",function(){J();t()});$("#lrServiceBar").tooltip();$("#maincontent").on("click",".showSM",function(){I("SM",$(this).attr("data-smno"),$(this).attr("data-smid"));return!1});$("#maincontent").on("click",
...
U();aa();ba();G("main");t()}function G(b){$("#numPagination").hide();$("#alphaPagination").hide();if("main"===b){if("undefined"!==typeof Storage&&(b=localStorage.getItem("LobbyistDisclosure")))try{var a=JSON.parse(b);Q(a)}catch(d){}}else w=1,F("A")}function Y(b,a,d){"N"!==d||!$("#numPagination").is(":hidden")&&b===L&&a===M?"A"===d&&$("#alphaPagination").is(":hidden")&&($("#numPagination").hide(),$("#PageStatus").hide(),$("#alphaPagination").show()):(M=a,L=b,$("#numPagination").show(),$("#alphaPagination").hide(),
0<b?($("#numberPageSelection").bootpag({total:b,page:p}),$("#PageStatus").show()):($("#numberPageSelection").bootpag({total:1}),$("#PageStatus").hide()),$("#NoPages").html(b),$("#TotalRows").html(a),$("#PageNo").html(p))}function t(){$("#listLoader").modal("show");var b=v[q].Idx,a=A();""!==a&&"A"===v[q].Idx&&(b="N");r=[];var d=u,e=B+v[q].DataSource.replace("<PGNUM>",p).replace("<MAXRES>",x).replace("<PGALPHA>",d);""!==a&&(e=(e+a).replace("/startWith/"+d,""));-1<a.indexOf("keyword")&&(e=e.replace("disclosure",
"disclosure/search"),e=e.replace("/startWith/"+d,""));Z(e,b)}function fa(){for(var b=v[q].Cols,a=[],d=0;d<b.length;d++)a.push(H[b[d].column].size);return a}function ga(){for(var b=[],a=v[q].Cols,d=0;d<a.length;d++)b.push({text:H[a[d].column].header,style:"tableheader"});return b}function ca(){if(null===r.searchResultVOs)bootbox.alert("There is no data to report.");else{var b={pageSize:"LEGAL",pageOrientation:"landscape",footer:function(a,b){return{columns:[{text:"http://www1.toronto.ca/wps/portal/contentonly?vgnextoid=cf1fb7537e35f310VgnVCM10000071d60f89RCRD",
...
function ma(b){var a="",d=!1;"undefined"!==typeof b.inhouseLobbyistCommunicationMethodList&&0<b.inhouseLobbyistCommunicationMethodList.length&&($.each(b.inhouseLobbyistCommunicationMethodList,function(b,c){d=!0;a+="<tr><td>&nbsp;</td></tr>";a+="<tr><td colspan='10'><b>"+f(c.inHouseLobbyistNameAndRegistrationNumber)+"</b></td>";a+="</tr>";a+="<tr class='detailMiniHdr'><td class='col-md-2'>Public Office Holder Type</td>";a+="<td class='col-md-3'>Name or Position Title</td>";a+="<td class='col-md-3'>Ward, Office, Division or Agency</td>";
a+="<td class='col-md-2'>Communication Date</td>";a+="<td class='col-md-2'>Communication Methods Used</td>";a+="</tr>";$.each(c.pohCommunicationMethodList,function(b,c){a+="<tr><td class='col-md-2'>"+f(c.pohType)+"</td>";a+="<td class='col-md-3'>"+f(c.pohNameOrTitle)+"</td>";a+="<td class='col-md-3'>"+f(c.pohOfficeName)+"</td>";a+="<td class='col-md-2'>"+f(c.communicationDate)+"</td>";a+="<td class='col-md-2'>"+c.communicationMethod+"</td>";a+="</tr>"})}),$("#CommunicationsSection").find("tbody").html(a));
"undefined"!==typeof b.pohCommunicationMethodList&&0<b.pohCommunicationMethodList.length&&(a+="<tr class='detailMiniMajorHdr'><td class='col-md-2'>Public Office Holder Type</td>",a+="<td class='col-md-3'>Name or Position Title</td>",a+="<td class='col-md-3'>Ward, Office, Division or Agency</td>",a+="<td class='col-md-2'>Communication Date</td>",a+="<td class='col-md-2'>Communication Methods Used</td>",a+="</tr>",$.each(b.pohCommunicationMethodList,function(b,c){d=!0;a+="<tr><td class='col-md-2'>"+
f(c.pohType)+"</td>";a+="<td class='col-md-3'>"+f(c.pohNameOrTitle)+"</td>";a+="<td class='col-md-3'>"+f(c.pohOfficeName)+"</td>";a+="<td class='col-md-2'>"+f(c.communicationDate)+"</td>";a+="<td class='col-md-2'>"+c.communicationMethod+"</td>";a+="</tr>"}),$("#CommunicationsSection").find("tbody").html(a));d?$("#pohAccordion").show():$("#pohAccordion").hide()}function la(b){var a=0,d="",e=!1;b.meetingList&&0<b.meetingList.length?($.each(b.meetingList,function(b,g){d+="<tr><td>&nbsp;</td></tr>";d+=
"<tr class='labelRow'><td>"+f(g.committeeName)+"</td></tr>";d+="<tr><td>Meeting Date "+f(g.meetingDate)+"</td></tr>";d+="<tr><td>&nbsp;</td></tr>";if("undefined"!==typeof g.attendeeCommitteeMemberList&&g.attendeeCommitteeMemberList){e=!1;var m=g.attendeeCommitteeMemberList;for(a=0;a<m.length;a++)e||(d+="<tr class='labelRow'><td>Commitee Members in Attendance</td></tr>",e=!0),d+="<tr><td class='CommListIndent'>"+f(m[a])+"</td></tr>"}d+="<tr><td>&nbsp;</td></tr>";if("undefined"!==typeof g.attendeeInhouseLobbyistList&&
g.attendeeInhouseLobbyistList)for(m=g.attendeeInhouseLobbyistList,e=!1,a=0;a<m.length;a++)e||(d+="<tr class='labelRow'><td>In-house Lobbyists in Attendance</td></tr>",e=!0),d+="<tr><td class='CommListIndent'>"+f(m[a])+")</td></tr>";if("undefined"!==typeof g.attendeePOHList&&g.attendeePOHList)for(d+="<tr><td>&nbsp;</td></tr>",d+="<tr class='labelRow'><td>Public Office Holders in Attendance</td></tr>",d+="<tr class='labelRow'><td>Type</td>",d+="<td>Name or Position Title</td>",d+="<td>Ward, Office, Division or Agency</td>",
d+="</tr>",m=g.attendeePOHList,a=0;a<m.length;a++)d+="<tr><td>"+f(m[a].pohType)+"</td>",d+="<td>"+f(m[a].pohNameOrTitle)+"</td>",d+="<td>"+f(m[a].pohOfficeName)+"</td>",d+="</tr>"}),$("#MeetingsSection").find("tbody").html(d),$("#meetAccordion").show()):$("#meetAccordion").hide()}function na(){var b="";0===document.location.hostname.length?(b+='<link rel="stylesheet" href="css/lobbySearch.css"><link rel="stylesheet" href="js/datepicker/datepicker.css">',b+='<link rel="stylesheet" href="static_files/assets/css/bootstrap-multiselect.css">',
b+='<link rel="stylesheet" href="/tablesorter/css/theme.blue.css">',b+='<script type="text/javascript" src="static_files/assets/multiselect/bootstrap-multiselect.js">\x3c/script>',b+='<script type="text/javascript" src="js/datepicker/bootstrap-datepicker.js">\x3c/script>',b+='<script type="text/javascript" src="static_files/assets/datepicker/moment-with-locales.js">\x3c/script>',b+='<script type="text/javascript" src="js/typeahead.bundle.js">\x3c/script>',b+='<script type="text/javascript" src="js/jquery.bootpag.min.js">\x3c/script>',
b+='<script type="text/javascript" src="js/placeholders.jquery.js">\x3c/script>',b+='<script type="text/javascript"  src="js/bootbox.min.js">\x3c/script>',b+='<script type="text/javascript"  src="static_files/assets/pdfmake/pdfmake.min.js">\x3c/script>',b+='<script type="text/javascript"  src="static_files/assets/pdfmake/vfs_fonts.js">\x3c/script>',$("#appCode").html(b),$("#appDisplay").load("html/lobbyListing.html",function(){K()})):(b+='<link rel="stylesheet" href="/datepicker/datepicker.css">',
b+='<link rel="stylesheet" href="/static_files/assets/multiselect/bootstrap-multiselect.css">',b+='<link rel="stylesheet" href="/tablesorter/css/theme.blue.css">',b+='<link rel="stylesheet" href="//netdna.bootstrapcdn.com/font-awesome/3.2.1/css/font-awesome.css">',b+='<link rel="stylesheet" href="/City%20Of%20Toronto/Sandbox/Steve/LobbyRegistry3/css/lobbySearch.css">',b+='<script type="text/javascript" src="/static_files/assets/multiselect/bootstrap-multiselect.js">\x3c/script>',b+='<script type="text/javascript" src="/datepicker/bootstrap-datepicker.js">\x3c/script>',
b+='<script type="text/javascript" src="/static_files/assets/datepicker/moment-with-locales.js">\x3c/script>',b+='<script type="text/javascript" src="/City%20Of%20Toronto/Sandbox/Steve/LobbyRegistry2/js/typeahead.bundle.js">\x3c/script>',b+='<script type="text/javascript" src="/City%20Of%20Toronto/Sandbox/Steve/LobbyRegistry2/js/jquery.bootpag.min.js">\x3c/script>',b+='<script type="text/javascript" src="/static_files/assets/bootbox/bootbox.min.js">\x3c/script>',b+='<script type="text/javascript" src="/static_files/assets/placeholders/jquery.placeholder.min.js">\x3c/script>',
b+='<script type="text/javascript"  src="/static_files/assets/pdfmake/pdfmake.min.js">\x3c/script>',b+='<script type="text/javascript"  src="/static_files/assets/pdfmake/vfs_fonts.js">\x3c/script>',$("#appCode").html(b),$("#appDisplay").load("/City%20Of%20Toronto/Sandbox/Steve/LobbyRegistry3/html/lobbyListing.html",function(){K()}))}function P(b,a,d,e){var c="";0===document.location.hostname.length?(c+='<link rel="stylesheet" href="css/SMDetail.css"><link rel="stylesheet" href="js/datepicker/datepicker.css">',
c+='<link rel="stylesheet" href="static_files/assets/css/bootstrap-multiselect.css">',c+='<link rel="stylesheet" href="/tablesorter/css/theme.blue.css">',c+='<link rel="stylesheet" href="http://netdna.bootstrapcdn.com/font-awesome/3.2.1/css/font-awesome.css">',c+='<script type="text/javascript" src="static_files/assets/multiselect/bootstrap-multiselect.js">\x3c/script>',c+='<script type="text/javascript" src="js/datepicker/bootstrap-datepicker.js">\x3c/script>',c+='<script type="text/javascript" src="static_files/assets/datepicker/moment-with-locales.js">\x3c/script>',
c+='<script type="text/javascript" src="js/typeahead.bundle.js">\x3c/script>',c+='<script type="text/javascript" src="js/jquery.bootpag.min.js">\x3c/script>',c+='<script type="text/javascript" src="js/jquery.jmHighlight.min.js">\x3c/script>',c+='<script type="text/javascript"  src="js/bootbox.min.js">\x3c/script>',c+='<script type="text/javascript" src="js/placeholders.jquery.js">\x3c/script>',c+='<script type="text/javascript"  src="static_files/assets/pdfmake/pdfmake.min.js">\x3c/script>',c+='<script type="text/javascript"  src="static_files/assets/pdfmake/vfs_fonts.js">\x3c/script>',
...
a);$.ajax({type:"GET",url:b,crossDomain:!0,dataType:"json",success:function(b){0===b.length?bootbox.alert("detail record unexpectedly mising"):P(b,null,a,d)},error:function(a,b,d){console.log(a.status);console.log(d);bootbox.alert("detail record unexpectedly mising")}})}var O,B="http://was-inter-qa.toronto.ca",r=[],x=10,p=1,w=1,L=0,M=0,u="A",q="SMRpt",y={},H={SMLLobbyist:{header:"Lobbyist",size:"*"},SMLGovAgency:{header:"Gov Agency",size:"*"},SMLFinContributors:{header:"Financial Contributors",size:"*"},
