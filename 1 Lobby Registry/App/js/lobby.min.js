...
else{for(var b=[],a,d=u[q].Cols,e=0;e<d.length;e++)b.push(H[d[e].column].header);a=b.join(",")+"\r\n";$.each(r.searchResultVOs,function(d,c){b=[];for(var e=0;e<u[q].Cols.length;e++)switch(u[q].Cols[e].column){case "SMLLobbyist":b.push(m(c.lobbyistName));break;case "SMLLobbyistNames":b.push(m(c.lobbyistList));break;case "SMLPOHName":b.push(m(c.pohName));break;case "SMLPOHNameTitle":b.push(m(c.pohNameOrTitle));break;case "SMLPOHPosition":b.push(m(c.pohName));break;case "SMLPOHType":b.push(m(c.pohType));
