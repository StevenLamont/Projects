...
"",style:"tblcol"});break;case "SMLDateOfRequest":a.table.body[d].push({text:c.dateOfRequest||"",style:"tblcol"});break;case "SMLSubjectMatterNo":a.table.body[d].push({text:c.subjectMatterNumber||"",style:"tblcol"});break;case "SMLLobRegNo":a.table.body[d].push({text:c.lobbyistRegistrationNumber||"",style:"tblcol"})}d++});b.content.push(a);pdfMake.createPdf(b).download("Lobby Registry Data.pdf")}}function m(b){return'"'+b+'"'}function da(){if(null===r.searchResultVOs)bootbox.alert("There is no data to report.");
else{for(var b=[],a,d=v[q].Cols,e=0;e<d.length;e++)b.push(H[d[e].column].header);a=b.join(",")+"\r\n";$.each(r.searchResultVOs,function(d,c){b=[];for(var e=0;e<v[q].Cols.length;e++)switch(v[q].Cols[e].column){case "SMLLobbyist":b.push(m(c.lobbyistName));break;case "SMLLobbyistNames":b.push(m(c.lobbyistList));break;case "SMLPOHName":b.push(m(c.pohName));break;case "SMLPOHNameTitle":b.push(m(c.pohNameOrTitle));break;case "SMLPOHPosition":b.push(m(c.pohName));break;case "SMLPOHType":b.push(m(c.pohType));
break;case "SMLFinContributor":b.push(m(c.financialContributor));break;case "SMLFinContributors":b.push(m(c.financialContributors.join(", ")));break;case "SMLLobbyistType":b.push(m(c.lobbyistType));break;case "SMLBeneficiary":b.push(m(c.beneficiaryName));break;case "SMLBeneficiaries":b.push(m(c.beneficiaries.join(", ")));break;case "SMLBusOrg":b.push(m(c.businessOrganization));break;case "SMLClient":b.push(m(c.client));break;case "SMLSubjectMatter":b.push(m(c.subjectMatter));break;case "SMLStatus":b.push(m(c.status));
break;case "SMLInitFileDate":b.push(m(c.InitialApprovalDate));break;case "SMLCommMethod":b.push(m(c.communicationMethod));break;case "SMLCommDate":b.push(m(c.communicationDate));break;case "SMLRequestMeeting":b.push(m(c.requestMeeting));break;case "SMLResultOfMeetingRequest":b.push(m(c.resultOfMeetingRequest));break;case "SMLDateOfRequest":b.push(m(c.dateOfRequest));break;case "SMLSubjectMatterNo":b.push(m(c.subjectMatterNumber));break;case "SMLLobRegNo":b.push(m(c.lobbyistRegistrationNumber))}a+=
b.join(",")+"\r\n"});d=navigator.userAgent;e=99;1<d.indexOf("MSIE")&&(e=parseInt(d.substr(d.indexOf("MSIE")+5,5),10));if(10>e)bootbox.alert("You are using an old version of Internet Explorer that does not allow for file export.  Please upgrade to a more up to date browser in order to use this feature.");else if(e=new Blob([a],{type:"text/csv;charset=utf-8"}),navigator.msSaveBlob)navigator.msSaveBlob(e,"Lobby Registry Data.csv");else{var c=window.URL||window.webkitURL,d=document.createElementNS("http://www.w3.org/1999/xhtml",
"a");d.href=c.createObjectURL(e);d.download="Lobby Registry Data.csv";e=document.createEvent("MouseEvents");e.initEvent("click",!0,!1);d.dispatchEvent(e)}}}function z(b,a,d,e){var c={};c.Line=g(b);c.Line+=g(a)?"<br>"+g(a):"";c.CityProv=g(d);c.PostCty=g(e);c.Addr=g(c.Line);c.Addr+=g(c.CityProv)?"<br>"+g(c.CityProv):"";c.Addr+=g(c.PostCty)?"<br>"+g(c.PostCty):"";return c}function N(b,a,d,e){$("#BackTo").prop("href","/wps/portal/contentonly?vgnextoid="+O);ea();null!==d?$("#headerText").text("Lobbyist Details"):
$("#headerText").text("Subject Matter Details");if($.isEmptyObject(b))bootbox.alert("detail record unexpectedly mising");else{$(".SMIn-house").hide();$(".SMVoluntary").hide();$(".SMConsultant").hide();$(".SM"+b.lobbyistType).show();a="subjectMatterNumber subjectMatterStatus subjectMatterInitialApprovalDate subjectMatterRecentApprovalDate subjectMatter subjectMatterDecisionIssue subjectMatterStartDate lobbyistName lobbyistRegistrationNumber lobbyistRegistrationStatus lobbyistType lobbyistPositionTitle lobbyistRegistrationMostRecentApprovalDate lobbyistPhone lobbyistPrevPubOfficeHolder businessOrganizationName businessOtherTradeName businessType businessFiscalStartDate businessDescription clientName clientOtherTradeName".split(" ");
...
typeof b.financialContributionList&&0<b.financialContributionList.length){d=b.financialContributionList;a+="<tr class='labelRow'><td>Contributor</td><td>Contact Name</td></tr>";for(var c=0;c<d.length;c++)a+="<tr><td>"+(c+1)+". "+g(d[c].financialContributor)+"</td>",""!==d[c].contactName&&(a+="<td>"+g(d[c].contactName)+"</td>"),a+="</tr>";$("#PrivateFundingSection").find("tbody").html(a);$("#pfAccordion").show()}else $("#pfAccordion").hide();ja(b);ka(b);la(b);a="";if("undefined"!==typeof b.committeeList&&
0<b.committeeList.length){for(d=0;d<b.committeeList.length;d++)if(c=b.committeeList[d],a+="<tr class='labelRow'><td>"+g(c.committeeName)+"</td></tr>","undefined"!==typeof c.committeeMemberList)for(var f=0;f<c.committeeMemberList.length;f++){var m=c.committeeMemberList[f];0===f&&(a+="<tr class='labelRow'><td class='CommListIndent'>Commitee Members</td></tr>");a+="<tr><td class='CommListIndent'>"+g(m)+"</td></tr>"}$("#CommitteeSection").find("tbody").html(a).trigger("update");$("#committeeAccordion").show()}else $("#committeeAccordion").hide();
ma(b);$("#appDisplay").jmHighlight(e,{separateWordSearch:!0})}}function ha(b){var a="",d=1;"undefined"!==typeof b.inhouseLobbyistList&&0<b.inhouseLobbyistList.length?(a+="<tr><td>&nbsp;</td></tr>",$.each(b.inhouseLobbyistList,function(b,c){var f=z(c.inhouseLobbyistAddress,c.inhouseLobbyistAddress2,c.inhouseLobbyistCityProvince,c.inhouseLobbyistCountryPostalCode);a+="<tr class='labelRow'><td>"+d+". In-house Lobbyist's Name</td>";a+="<td>Lobbyist Registration Number</td>";a+="<td>    Position title</td>";
a+="</tr>";a+="<tr><td>"+g(c.inhouseLobbyistName)+"</td>";a+="<td>"+g(c.inhouseLobbyistRegistrationNumber)+"</td>";a+="<td>"+g(c.inhouseLobbyistPositionTitle)+"</td>";a+="</tr>";a+="<tr class='labelRow'><td>Business Address</td>";a+="<td>Phone</td>";a+="</tr>";a+="<tr><td>"+f.Addr+"</td>";a+="<td>"+g(c.inhouseLobbyistTelephone)+"</td>";a+="</tr>";a+="<tr class='labelRow'>";a+="<td colspan='3' >Has this in-house lobbyist held a senior public office position with the City of Toronto in the past 12 months?</td>";
a+="</tr>";a+="<td colspan='2'>"+g(c.inhouseLobbyistPrevPubOfficeHolder)+"</td>";a+="</tr>";d++}),$("#SMLSection").find("tbody").html(a),$("#smlAccordion").show()):$("#smlAccordion").hide()}function ia(b){var a="",d=1;"undefined"!==typeof b.otherBeneficiaryList&&0<b.otherBeneficiaryList.length?($.each(b.otherBeneficiaryList,function(b,c){var f=z(c.beneficiaryAddress,c.beneficiaryAddress2,c.beneficiaryCityProvince,c.beneficiaryCountryPostalCode);a+="<tr class='labelRow'><td>"+d+". "+c.beneficiaryType+
"</td>";a+="<td>Other Trade Names</td>";a+="<td>Address</td>";a+="</tr>";a+="<tr><td>"+g(c.beneficiaryName)+"</td>";a+="<td>"+g(c.beneficiaryOtherTradeName)+"</td>";a+="<td>"+f.Addr+"</td>";a+="</tr>";d++}),$("#OtherBeneficiariesSection").find("tbody").html(a),$("#othbAccordion").show()):$("#othbAccordion").hide()}function ja(b){var a="";"undefined"!==typeof b.gmtFundingList&&0<b.gmtFundingList.length?($.each(b.gmtFundingList,function(b,e){a+="<tr><td>"+(b+1)+". "+g(e.governmentName)+", "+g(e.departmentProgramName)+
"</td></tr>"}),$("#GovernmentFundingSection").find("tbody").html(a),$("#gfAccordion").show()):$("#gfAccordion").hide()}function ka(b){var a="";"undefined"!==typeof b.grassRootsCommunicationList&&0<b.grassRootsCommunicationList.length?($.each(b.grassRootsCommunicationList,function(b,e){a+="<tr><td>&nbsp;</td></tr>";a+="<tr><td>"+g(e.grassRootCommunity)+"</td>";a+="<td>"+g(e.grassRootTarget)+"</td>";a+="<td>"+g(e.grassRootStartDate)+" to "+g(e.grassRootEndDate)+"</td>";a+="</tr>"}),$("#GrassRootsSection").find("tbody").html(a),
$("#grAccordion").show()):$("#grAccordion").hide()}function ma(b){var a="",d=!1;"undefined"!==typeof b.inhouseLobbyistCommunicationMethodList&&0<b.inhouseLobbyistCommunicationMethodList.length&&($.each(b.inhouseLobbyistCommunicationMethodList,function(b,c){d=!0;a+="<tr><td>&nbsp;</td></tr>";a+="<tr><td colspan='10'><b>"+g(c.inHouseLobbyistNameAndRegistrationNumber)+"</b></td>";a+="</tr>";a+="<tr class='detailMiniHdr'><td class='col-md-2'>Public Office Holder Type</td>";a+="<td class='col-md-2'>Name or Position Title</td>";
a+="<td class='col-md-2'>Ward, Office, Division or Agency</td>";a+="<td class='col-md-1'>Communication Date</td>";a+="<td class='col-md-1'>Communication Methods Used</td>";a+="<td class='col-md-1'>Request a Meeting</td>";a+="<td class='col-md-2'>Result of Request</td>";a+="<td class='col-md-1'>Date of Request</td>";a+="</tr>";$.each(c.pohCommunicationMethodList,function(b,c){a+="<tr><td class='col-md-2'>"+g(c.pohType)+"</td>";a+="<td class='col-md-2'>"+g(c.pohNameOrTitle)+"</td>";a+="<td class='col-md-2'>"+
g(c.pohOfficeName)+"</td>";a+="<td class='col-md-1'>"+g(c.communicationDate)+"</td>";a+="<td class='col-md-1'>"+c.communicationMethod+"</td>";a+="<td class='col-md-1'>"+c.requestMeeting+"</td>";a+="<td class='col-md-2'>"+c.resultOfMeetingRequest+"</td>";a+="<td class='col-md-1'>"+c.dateOfRequest+"</td>";a+="</tr>"})}),$("#CommunicationsSection").find("tbody").html(a));"undefined"!==typeof b.pohCommunicationMethodList&&0<b.pohCommunicationMethodList.length&&(a+="<tr class='detailMiniMajorHdr'><td class='col-md-2'>Public Office Holder Type</td>",
a+="<td class='col-md-2'>Name or Position Title</td>",a+="<td class='col-md-2'>Ward, Office, Division or Agency</td>",a+="<td class='col-md-1'>Communication Date</td>",a+="<td class='col-md-1'>Communication Methods Used</td>",a+="<td class='col-md-1'>Request a Meeting</td>",a+="<td class='col-md-2'>Result of Request</td>",a+="<td class='col-md-1'>Date of Request</td>",a+="</tr>",$.each(b.pohCommunicationMethodList,function(b,c){d=!0;a+="<tr><td class='col-md-2'>"+g(c.pohType)+"</td>";a+="<td class='col-md-2'>"+
g(c.pohNameOrTitle)+"</td>";a+="<td class='col-md-2'>"+g(c.pohOfficeName)+"</td>";a+="<td class='col-md-1'>"+g(c.communicationDate)+"</td>";a+="<td class='col-md-1'>"+c.communicationMethod+"</td>";a+="<td class='col-md-1'>"+c.requestMeeting+"</td>";a+="<td class='col-md-2'>"+c.resultOfMeetingRequest+"</td>";a+="<td class='col-md-1'>"+c.dateOfRequest+"</td>";a+="</tr>"}),$("#CommunicationsSection").find("tbody").html(a));d?$("#pohAccordion").show():$("#pohAccordion").hide()}function la(b){var a=0,
d="",e=!1;b.meetingList&&0<b.meetingList.length?($.each(b.meetingList,function(b,f){d+="<tr><td>&nbsp;</td></tr>";d+="<tr class='labelRow'><td>"+g(f.committeeName)+"</td></tr>";d+="<tr><td>Meeting Date: "+g(f.meetingDate)+"</td></tr>";d+="<tr><td>&nbsp;</td></tr>";if("undefined"!==typeof f.attendeeCommitteeMemberList&&f.attendeeCommitteeMemberList){e=!1;var m=f.attendeeCommitteeMemberList;for(a=0;a<m.length;a++)e||(d+="<tr class='labelRow'><td>Commitee Members in Attendance</td></tr>",e=!0),d+="<tr><td class='CommListIndent'>"+
g(m[a])+"</td></tr>"}d+="<tr><td>&nbsp;</td></tr>";if("undefined"!==typeof f.attendeeInhouseLobbyistList&&f.attendeeInhouseLobbyistList)for(m=f.attendeeInhouseLobbyistList,e=!1,a=0;a<m.length;a++)e||(d+="<tr class='labelRow'><td>In-house Lobbyists in Attendance</td></tr>",e=!0),d+="<tr><td class='CommListIndent'>"+g(m[a])+")</td></tr>";if("undefined"!==typeof f.attendeePOHList&&f.attendeePOHList)for(d+="<tr><td>&nbsp;</td></tr>",d+="<tr class='labelRow'><td>Public Office Holders in Attendance</td></tr>",
d+="<tr class='labelRow'><td>Type</td>",d+="<td>Name or Position Title</td>",d+="<td>Ward, Office, Division or Agency</td>",d+="</tr>",m=f.attendeePOHList,a=0;a<m.length;a++)d+="<tr><td>"+g(m[a].pohType)+"</td>",d+="<td>"+g(m[a].pohNameOrTitle)+"</td>",d+="<td>"+g(m[a].pohOfficeName)+"</td>",d+="</tr>"}),$("#MeetingsSection").find("tbody").html(d),$("#meetAccordion").show()):$("#meetAccordion").hide()}function na(){var b="";0===document.location.hostname.length?(b+='<link rel="stylesheet" href="css/lobbySearch.css"><link rel="stylesheet" href="js/datepicker/datepicker.css">',
b+='<link rel="stylesheet" href="static_files/assets/css/bootstrap-multiselect.css">',b+='<link rel="stylesheet" href="/tablesorter/css/theme.blue.css">',b+='<script type="text/javascript" src="static_files/assets/multiselect/bootstrap-multiselect.js">\x3c/script>',b+='<script type="text/javascript" src="js/datepicker/bootstrap-datepicker.js">\x3c/script>',b+='<script type="text/javascript" src="static_files/assets/datepicker/moment-with-locales.js">\x3c/script>',b+='<script type="text/javascript" src="js/typeahead.bundle.js">\x3c/script>',
b+='<script type="text/javascript" src="js/jquery.bootpag.min.js">\x3c/script>',b+='<script type="text/javascript" src="js/placeholders.jquery.js">\x3c/script>',b+='<script type="text/javascript"  src="js/bootbox.min.js">\x3c/script>',b+='<script type="text/javascript"  src="static_files/assets/pdfmake/pdfmake.min.js">\x3c/script>',b+='<script type="text/javascript"  src="static_files/assets/pdfmake/vfs_fonts.js">\x3c/script>',$("#appCode").html(b),$("#appDisplay").load("html/lobbyListing.html",function(){K()})):
(b+='<link rel="stylesheet" href="/datepicker/datepicker.css">',b+='<link rel="stylesheet" href="/static_files/assets/multiselect/bootstrap-multiselect.css">',b+='<link rel="stylesheet" href="/tablesorter/css/theme.blue.css">',b+='<link rel="stylesheet" href="//netdna.bootstrapcdn.com/font-awesome/3.2.1/css/font-awesome.css">',b+='<link rel="stylesheet" href="/City%20Of%20Toronto/Sandbox/Steve/LobbyRegistry3/css/lobbySearch.css">',b+='<script type="text/javascript" src="/static_files/assets/multiselect/bootstrap-multiselect.js">\x3c/script>',
b+='<script type="text/javascript" src="/datepicker/bootstrap-datepicker.js">\x3c/script>',b+='<script type="text/javascript" src="/static_files/assets/datepicker/moment-with-locales.js">\x3c/script>',b+='<script type="text/javascript" src="/City%20Of%20Toronto/Sandbox/Steve/LobbyRegistry2/js/typeahead.bundle.js">\x3c/script>',b+='<script type="text/javascript" src="/City%20Of%20Toronto/Sandbox/Steve/LobbyRegistry2/js/jquery.bootpag.min.js">\x3c/script>',b+='<script type="text/javascript" src="/static_files/assets/bootbox/bootbox.min.js">\x3c/script>',
b+='<script type="text/javascript" src="/static_files/assets/placeholders/jquery.placeholder.min.js">\x3c/script>',b+='<script type="text/javascript"  src="/static_files/assets/pdfmake/pdfmake.min.js">\x3c/script>',b+='<script type="text/javascript"  src="/static_files/assets/pdfmake/vfs_fonts.js">\x3c/script>',$("#appCode").html(b),$("#appDisplay").load("/City%20Of%20Toronto/Sandbox/Steve/LobbyRegistry3/html/lobbyListing.html",function(){K()}))}function P(b,a,d,e){var c="";0===document.location.hostname.length?
(c+='<link rel="stylesheet" href="css/SMDetail.css"><link rel="stylesheet" href="js/datepicker/datepicker.css">',c+='<link rel="stylesheet" href="static_files/assets/css/bootstrap-multiselect.css">',c+='<link rel="stylesheet" href="/tablesorter/css/theme.blue.css">',c+='<link rel="stylesheet" href="http://netdna.bootstrapcdn.com/font-awesome/3.2.1/css/font-awesome.css">',c+='<script type="text/javascript" src="static_files/assets/multiselect/bootstrap-multiselect.js">\x3c/script>',c+='<script type="text/javascript" src="js/datepicker/bootstrap-datepicker.js">\x3c/script>',
c+='<script type="text/javascript" src="static_files/assets/datepicker/moment-with-locales.js">\x3c/script>',c+='<script type="text/javascript" src="js/typeahead.bundle.js">\x3c/script>',c+='<script type="text/javascript" src="js/jquery.bootpag.min.js">\x3c/script>',c+='<script type="text/javascript" src="js/jquery.jmHighlight.min.js">\x3c/script>',c+='<script type="text/javascript"  src="js/bootbox.min.js">\x3c/script>',c+='<script type="text/javascript" src="js/placeholders.jquery.js">\x3c/script>',
c+='<script type="text/javascript"  src="static_files/assets/pdfmake/pdfmake.min.js">\x3c/script>',c+='<script type="text/javascript"  src="static_files/assets/pdfmake/vfs_fonts.js">\x3c/script>',$("#appCode").html(c),$("#appDisplay").load("html/SMDetail.html",function(){N(b,a,d,e)})):(c+='<link rel="stylesheet" href="/datepicker/datepicker.css">',c+='<link rel="stylesheet" href="/static_files/assets/multiselect/bootstrap-multiselect.css">',c+='<link rel="stylesheet" href="/tablesorter/css/theme.blue.css">',
c+='<link rel="stylesheet" href="//netdna.bootstrapcdn.com/font-awesome/3.2.1/css/font-awesome.css">',c+='<link rel="stylesheet" href="/City%20Of%20Toronto/Sandbox/Steve/LobbyRegistry3/css/SMDetail.css">',c+='<script type="text/javascript" src="/static_files/assets/multiselect/bootstrap-multiselect.js">\x3c/script>',c+='<script type="text/javascript" src="/datepicker/bootstrap-datepicker.js">\x3c/script>',c+='<script type="text/javascript" src="/static_files/assets/datepicker/moment-with-locales.js">\x3c/script>',
c+='<script type="text/javascript" src="/City%20Of%20Toronto/Sandbox/Steve/LobbyRegistry2/js/typeahead.bundle.js">\x3c/script>',c+='<script type="text/javascript" src="/City%20Of%20Toronto/Sandbox/Steve/LobbyRegistry2/js/jquery.bootpag.min.js">\x3c/script>',c+='<script type="text/javascript" src="/static_files/assets/highlights/jquery.jmHighlight.min.js">\x3c/script>',c+='<script type="text/javascript" src="/static_files/assets/bootbox/bootbox.min.js">\x3c/script>',c+='<script type="text/javascript" src="/static_files/assets/placeholders/jquery.placeholder.min.js">\x3c/script>',
$("#appCode").html(c),$("#appDisplay").load("/City%20Of%20Toronto/Sandbox/Steve/LobbyRegistry3/html/SMDetail.html",function(){N(b,a,d,e)}))}function oa(b,a,d,e){$.support.cors=!0;b=B+"/LobbyistRegistryRestWeb/disclosure/subjectMatterDetails?callback=?&subjectMatterId=<SMID>".replace("<SMID>",a);$.ajax({type:"GET",url:b,crossDomain:!0,dataType:"json",success:function(b){0===b.length?bootbox.alert("detail record unexpectedly mising"):P(b,a,null,e)},error:function(a,b,d){console.log(a.status);console.log(d);
bootbox.alert("detail record unexpectedly mising")}})}function pa(b,a,d){$.support.cors=!0;b=B+"/LobbyistRegistryRestWeb/disclosure/lobbyistDetails?callback=?&lobbyistRegistrationId=<LRID>".replace("<LRID>",a);$.ajax({type:"GET",url:b,crossDomain:!0,dataType:"json",success:function(b){0===b.length?bootbox.alert("detail record unexpectedly mising"):P(b,null,a,d)},error:function(a,b,d){console.log(a.status);console.log(d);bootbox.alert("detail record unexpectedly mising")}})}var O,B="http://was-inter-qa.toronto.ca",
r=[],x=10,p=1,w=1,L=0,M=0,u="A",q="SMRpt",y={},H={SMLLobbyist:{header:"Lobbyist",size:"*"},SMLGovAgency:{header:"Gov Agency",size:"*"},SMLFinContributors:{header:"Financial Contributors",size:"*"},SMLFinContributor:{header:"Financial Contributor",size:"*"},SMLBeneficiary:{header:"Beneficiary",size:"*"},SMLBeneficiaries:{header:"Beneficiaries",size:"*"},SMLLobbyistType:{header:"Lobbyist Type",size:"*"},SMLBusOrg:{header:"Business/Org",size:"*"},SMLBusOrgClient:{header:"Bus/Org/Client",size:"*"},SMLLobbyistNames:{header:"Lobbyist Name(s)",
size:"*"},SMLClient:{header:"Client",size:"*"},SMLPOHOfficeName:{header:"Office",size:"*"},SMLPOHName:{header:"Public Office Holder",size:"*"},SMLPOHNameTitle:{header:"Name or Position",size:"*"},SMLPOHPosition:{header:"Position",size:"*"},SMLPOHType:{header:"Type",size:"*"},SMLSubjectMatter:{header:"Subject Matter",size:"*"},SMLStatus:{header:"Status",size:"*"},SMLInitFileDate:{header:"Init Filing Date",size:"*"},SMLSubjectMatterNo:{header:"Subject Matter No",size:"*"},SMLLobRegNo:{header:"Lobbyist Reg No.",
size:"*"},SMLCommDate:{header:"Comm. Date",size:"*"},SMLCommMethod:{header:"Comm. Method",size:"*"},SMLRequestMeeting:{header:"Req. Meeting?",size:"*"},SMLResultOfMeetingRequest:{header:"Result of Req.",size:"*"},SMLDateOfRequest:{header:"Date of Req.",size:"*"}},v={SMRpt:{Idx:"N",DataSource:"/LobbyistRegistryRestWeb/disclosure/1?callback=?&pageNum=<PGNUM>&maxResults=<MAXRES>",Cols:[{column:"SMLLobbyistNames",cls:"",style:"width: 265px;white-space: normal;",label:"Lobbyist Name(s)",title:"Lobbyist Name(s)"},
{column:"SMLBusOrg",cls:"",style:"width: 265px;white-space: normal;",label:"Business/Org",title:"Business&#47;Organization"},{column:"SMLSubjectMatter",cls:"",style:"width: 345px;white-space: normal;",label:"Subject Matter",title:"Subject Matter"},{column:"SMLStatus",cls:"",style:"width: 70px;white-space: normal;",label:"Status",title:"Subject Matter Registration  Status"},{column:"SMLSubjectMatterNo",cls:"",style:"width: 100px;white-space: normal;",label:"Subject Matter No.",title:"Subject Matter Registration No."}]},
LobbyRpt:{Idx:"A",DataSource:"/LobbyistRegistryRestWeb/disclosure/startWith/<PGALPHA>/2?callback=?&pageNum=<PGNUM>&maxResults=<MAXRES>",Cols:[{column:"SMLLobbyist",cls:"",style:"width: 150px;white-space: normal;",label:"Lobbyist Name",title:"Lobbyist Name"},{column:"SMLLobbyistType",cls:"",style:"width: 82px;white-space: normal;",label:"Lobbyist Type",title:"Lobbyist Type"},{column:"SMLBusOrg",cls:"",style:"width: 185px;white-space: normal;",label:"Business/Org",title:"Business&#47;Organization"},
{column:"SMLClient",cls:"",style:"width: 185px;white-space: normal;",label:"Client",title:"Client"},{column:"SMLSubjectMatter",cls:"",style:"width: 205px;white-space: normal;",label:"Subject Matter",title:"Subject Matter"},{column:"SMLLobRegNo",cls:"",style:"width: 95px;",label:"Lobbyist<br />Reg No.",title:"Lobbyist Registration No."},{column:"SMLSubjectMatterNo",cls:"",style:"width: 100px;white-space: normal;",label:"Subject Matter No.",title:"Subject Matter Registration No."}]},POHNameRpt:{Idx:"N",
DataSource:"/LobbyistRegistryRestWeb/disclosure/3?callback=?&pageNum=<PGNUM>&maxResults=<MAXRES>",Cols:[{column:"SMLPOHNameTitle",cls:"",style:"width: 150px;",label:"Name or Position",title:"Public Office Holder Name"},{column:"SMLPOHType",cls:"",style:"width: 240px;",label:"Type",title:"Public Office Holder Type"},{column:"SMLSubjectMatter",cls:"",style:"width: 230px;white-space: normal;",label:"Subject Matter",title:"Subject Matter"},{column:"SMLLobbyistNames",cls:"",style:"width: 230px;white-space: normal;",
label:"Lobbyist Name(s)",title:"Lobbyist Name(s)"},{column:"SMLStatus",cls:"",style:"width: 70px;",label:"Status",title:"Subject Matter Registration Status"},{column:"SMLSubjectMatterNo",cls:"",style:"width: 100px;white-space: normal;",label:"Subject Matter No.",title:"Subject Matter Registration No."}]},POHCommRpt:{Idx:"N",DataSource:"/LobbyistRegistryRestWeb/disclosure/4?callback=?&pageNum=<PGNUM>&maxResults=<MAXRES>",Cols:[{column:"SMLPOHNameTitle",cls:"",style:"width: 95px;white-space: normal;",
label:"Name or Position",title:"Public Office Holder Name &#47; Position"},{column:"SMLPOHType",cls:"",style:"width: 95px;;white-space: normal;",label:"Type",title:"Public Office Holder Type"},{column:"SMLSubjectMatter",cls:"",style:"width: 95px;;white-space: normal;",label:"Subject Matter",title:"Subject Matter"},{column:"SMLLobbyist",cls:"",style:"width: 95px;white-space: normal;",label:"Lobbyist",title:"Lobbyist"},{column:"SMLCommDate",cls:"",style:"width: 95px;white-space: normal;",label:"Comm Date",
title:"Comm. Date"},{column:"SMLCommMethod",cls:"",style:"width: 95px;white-space: normal;",label:"Method",title:"Method"},{column:"SMLRequestMeeting",cls:"",style:"width: 95px;white-space: normal;",label:"Request a Meeting",title:"Request a Meeting"},{column:"SMLResultOfMeetingRequest",cls:"",style:"width: 95px;white-space: normal;",label:"Result of Request",title:"Result of Meeting Request. &#13;Only applies to Consultant/Voluntary"},{column:"SMLDateOfRequest",cls:"",style:"width: 95px;white-space: normal;",
label:"Date of Request",title:"Date of Request. &#13;Only applies to Consultant/Voluntary"},{column:"SMLSubjectMatterNo",cls:"",style:"width: 100px;white-space: normal;",label:"Subject Matter No.",title:"Subject Matter Registration No."}]},BenRpt:{Idx:"A",DataSource:"/LobbyistRegistryRestWeb/disclosure/startWith/<PGALPHA>/5?callback=?&pageNum=<PGNUM>&maxResults=<MAXRES>",Cols:[{column:"SMLBeneficiary",cls:"",style:"width: 150px;white-space: normal;",label:"Beneficiary",title:"Beneficiary"},{column:"SMLBusOrg",
cls:"",style:"width: 150px;white-space: normal;",label:"Business/Org",title:"Business&#47;Organization"},{column:"SMLClient",cls:"",style:"width: 150px;white-space: normal;",label:"Client",title:"Client"},{column:"SMLLobbyistNames",cls:"",style:"width: 210px;white-space: normal;",label:"Lobbyist Name(s)",title:"Lobbyist Name(s)"},{column:"SMLLobbyistType",cls:"",style:"width: 95px;white-space: normal;",label:"Lobbyist Type",title:"Lobbyist Type"},{column:"SMLFinContributors",cls:"",style:"width: 150px;white-space: normal;",
label:"Financial Contributors",title:"Financial Contributors"},{column:"SMLSubjectMatterNo",cls:"",style:"width: 100px;white-space: normal;",label:"Subject Matter No.",title:"Subject Matter Registration No."}]},BusOrgClientRpt:{Idx:"A",DataSource:"/LobbyistRegistryRestWeb/disclosure/startWith/<PGALPHA>/6?callback=?&pageNum=<PGNUM>&maxResults=<MAXRES>",Cols:[{column:"SMLBusOrg",cls:"",style:"width: 150px;white-space: normal;",label:"Business/Org",title:"Business&#47;Organization"},{column:"SMLClient",
cls:"",style:"width: 150px;white-space: normal;",label:"Client",title:"Client"},{column:"SMLLobbyistNames",cls:"",style:"width: 200px;white-space: normal;",label:"Lobbyist Name(s)",title:"Lobbyist Name(s)"},{column:"SMLLobbyistType",cls:"",style:"width: 95px;white-space: normal;",label:"Lobbyist Type",title:"Lobbyist Type"},{column:"SMLBeneficiaries",cls:"",style:"width: 190px;white-space: normal;",label:"Beneficiaries",title:"Beneficiaries"},{column:"SMLFinContributors",cls:"",style:"width: 110px;white-space: normal;",
label:"Financial Contributors",title:"Financial Contributors"},{column:"SMLSubjectMatterNo",cls:"",style:"width: 100px;white-space: normal;",label:"Subject Matter No.",title:"Subject Matter Registration No."}]},FinRpt:{Idx:"A",DataSource:"/LobbyistRegistryRestWeb/disclosure/startWith/<PGALPHA>/7?callback=?&pageNum=<PGNUM>&maxResults=<MAXRES>",Cols:[{column:"SMLFinContributor",cls:"",style:"width: 175px;white-space: normal;",label:"Financial Contributor",title:"Financial Contributor"},{column:"SMLBusOrg",
cls:"",style:"width: 160px;white-space: normal;",label:"Business/Org",title:"Business&#47;Organization"},{column:"SMLClient",cls:"",style:"width: 140px;white-space: normal;",label:"Client",title:"Client"},{column:"SMLLobbyistNames",cls:"",style:"width: 175px;white-space: normal;",label:"Lobbyist Name(s)",title:"Lobbyist Name(s)"},{column:"SMLLobbyistType",cls:"",style:"width: 95px;white-space: normal;",label:"Lobbyist Type",title:"Lobbyist Type"},{column:"SMLBeneficiaries",cls:"",style:"width: 110px;white-space: normal;",
label:"Beneficiaries",title:"Beneficiaries"},{column:"SMLStatus",cls:"",style:"width: 65px;",label:"Status",title:"Subject Matter Registration Status"},{column:"SMLSubjectMatterNo",cls:"",style:"width: 100px;white-space: normal;",label:"Subject Matter No.",title:"Subject Matter Registration No."}]}},T={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","/":"&#x2F;"};(function(b){var a;a=window.location.search.substr(1).split("&");if(""===a)a={};else{for(var d={},e=0;e<a.length;++e){var c=
a[e].split("=");2==c.length&&(d[c[0]]=decodeURIComponent(c[1].replace(/\+/g," ")))}a=d}b.QueryString=a})(jQuery);$(document).ready(function(){var b=$.QueryString.SM,a=$.QueryString.SMId,d=$.QueryString.LRId,e=$.QueryString.searchStr;O=$.QueryString.vgnextoid;d?pa(b,d,e):b?oa(b,a,null,e):($("#listLoader").modal("show"),na())})})();
